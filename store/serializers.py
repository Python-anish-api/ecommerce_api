...
from store.models import CancelledOrder, Cart, CartOrderItem, Notification, CouponUsers, Product,Category, DeliveryCouriers, CartOrder, Gallery,   Review,  Specification, Coupon, Color, Size, Address, Wishlist, Vendor
